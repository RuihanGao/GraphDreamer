...
# export P32="Crystal Ball is perched atop Wooden Desk"
# export P42="Ancient Spell Books are perched atop Wooden Desk"
# export P13="Wizard is gazing at Crystal Ball"
export P34="Crystal Ball is beside Ancient Spell Books"

export PG=[["$P12"],["$P23"],["$P24"],["$P34"]] # ["$P32"],["$P42"],["$P13"],
export E=[[0,1],[1,2],[1,3],[2,3]] # [2,1],[3,1],[0,2]
# export C=[[-0.25,0.1,0.],[0.24,0.12,0.],[0.25,0.13,0.2],[0.28,-0.16,0.2]]
# export R=[0.5,0.5,0.3,0.3]

# Name save folder:
export TG="05_wizard_study"
...
export RPG=[["$RP12"],["$RP23"],["$RP24"],["$RP34"]] # ["$RP32"],["$RP42"],["$RP13"],
