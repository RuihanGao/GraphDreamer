...
export P1="'Cup: White, ceramic'"
export P2="'Toothbrushes: Blue and green.'"
export P3="'Toothpaste Tube and Razor: Blue and white (tube), blue handle (razor).'"
export P4="'Soap Dish with Soaps: White dish, two soaps (white and beige).'"
export N_obj=4
...
export P12="Cup contains Toothbrushes"
export P13="Cup contains Toothpaste Tube and Razor"
export P14="Cup is beside Soap Dish with Soaps"
export P23="Toothbrushes are beside Toothpaste Tube and Razor"

export PG=[["$P12"],["$P13"],["$P14"],["$P23"]]
export E=[[0,1],[0,2],[0,3],[1,2]]
# export C=[[-0.25,0.1,0.],[0.24,0.12,0.],[0.25,0.13,0.2],[0.28,-0.16,0.2]]
# export R=[0.5,0.5,0.3,0.3]

# Name save folder:
export TG="10_toothbrush_soap_2"
...
export RP1="'a 4K DSLR high-resolution high-quality photo of a cup: white, ceramic'"
export RP2="'a 4K DSLR high-resolution high-quality photo of a toothbrush: blue and green.'"
export RP3="'a 4K DSLR high-resolution high-quality photo of a toothpaste tube and razor: blue and white (tube), blue handle (razor).'"
export RP4="'a 4K DSLR high-resolution high-quality photo of a soap dish with soaps: white dish, two soaps (white and beige).'"
...
export RPG=[["$RP12"],["$RP13"],["$RP14"],["$RP23"]]
